...
class TimeUnit(object):
    ...
    def __init__(self, MILLIS=None, MICROS=None,):
        self.MILLIS = MILLIS
        self.MICROS = MICROS
...
class EncryptionWithColumnKey(object):
    ...
    Attributes:
     ...
     - column_key_metadata: Retrieval metadata of the column-specific key *
    """


    def __init__(self, path_in_schema=None, column_key_metadata=None,):
        self.path_in_schema = path_in_schema
        self.column_key_metadata = column_key_metadata
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.column_key_metadata = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.path_in_schema is not None:
            ...
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_key_metadata is not None:
            oprot.writeFieldBegin('column_key_metadata', TType.STRING, 2)
            oprot.writeBinary(self.column_key_metadata)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ColumnChunk(object):
    ...
    metadata.
     ...
     - crypto_meta_data: Crypto metadata of encrypted columns *
    """


    def __init__(self, file_path=None, file_offset=None, meta_data=None, offset_index_offset=None, offset_index_length=None, column_index_offset=None, column_index_length=None, crypto_meta_data=None,):
        ...
        self.crypto_meta_data = crypto_meta_data
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.crypto_meta_data = ColumnCryptoMetaData()
                    self.crypto_meta_data.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.column_index_length is not None:
            ...
            oprot.writeFieldEnd()
        if self.crypto_meta_data is not None:
            oprot.writeFieldBegin('crypto_meta_data', TType.STRUCT, 8)
            self.crypto_meta_data.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class AesGcmV1(object):
    """
    Attributes:
     - aad_metadata: Retrieval metadata of AAD used for encryption of pages and structures *
    """


    def __init__(self, aad_metadata=None,):
        self.aad_metadata = aad_metadata
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.aad_metadata = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.aad_metadata is not None:
            oprot.writeFieldBegin('aad_metadata', TType.STRING, 1)
            oprot.writeBinary(self.aad_metadata)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class AesGcmCtrV1(object):
    """
    Attributes:
     - aad_metadata: Retrieval metadata of AAD used for encryption of structures *
    """
...
class FileCryptoMetaData(object):
    ...
    Attributes:
     ...
     - encrypted_footer: Parquet footer can be encrypted, or left as plaintext *
     - footer_key_metadata: Retrieval metadata of key used for encryption of footer,
    and (possibly) columns *
     - footer_offset: Offset of Parquet footer (encrypted, or plaintext) *
     - iv_prefix: If file IVs are comprised of a fixed part,
    and variable parts (random or counter), keep the fixed
    part here *
    """


    def __init__(self, encryption_algorithm=None, encrypted_footer=None, footer_key_metadata=None, footer_offset=None, iv_prefix=None,):
        self.encryption_algorithm = encryption_algorithm
        self.encrypted_footer = encrypted_footer
        self.footer_key_metadata = footer_key_metadata
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.encrypted_footer = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                    self.footer_key_metadata = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I64:
                    self.footer_offset = iprot.readI64()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                    self.iv_prefix = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.encryption_algorithm is not None:
            ...
            oprot.writeFieldEnd()
        if self.encrypted_footer is not None:
            oprot.writeFieldBegin('encrypted_footer', TType.BOOL, 2)
            oprot.writeBool(self.encrypted_footer)
            oprot.writeFieldEnd()
        if self.footer_key_metadata is not None:
            oprot.writeFieldBegin('footer_key_metadata', TType.STRING, 3)
            oprot.writeBinary(self.footer_key_metadata)
            oprot.writeFieldEnd()
        if self.footer_offset is not None:
            oprot.writeFieldBegin('footer_offset', TType.I64, 4)
            oprot.writeI64(self.footer_offset)
            oprot.writeFieldEnd()
        if self.iv_prefix is not None:
            oprot.writeFieldBegin('iv_prefix', TType.STRING, 5)
            oprot.writeBinary(self.iv_prefix)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.encrypted_footer is None:
            raise TProtocolException(message='Required field encrypted_footer is unset!')
        if self.footer_offset is None:
            raise TProtocolException(message='Required field footer_offset is unset!')
        return
...
EncryptionWithColumnKey.thrift_spec = (
    ...
    (2, TType.STRING, 'column_key_metadata', 'BINARY', None, ),  # 2
)
...
ColumnChunk.thrift_spec = (
    ...
    (8, TType.STRUCT, 'crypto_meta_data', [ColumnCryptoMetaData, None], None, ),  # 8
)
...
AesGcmV1.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'aad_metadata', 'BINARY', None, ),  # 1
)
...
FileCryptoMetaData.thrift_spec = (
    ...
    (2, TType.BOOL, 'encrypted_footer', None, None, ),  # 2
    (3, TType.STRING, 'footer_key_metadata', 'BINARY', None, ),  # 3
    (4, TType.I64, 'footer_offset', None, None, ),  # 4
    (5, TType.STRING, 'iv_prefix', 'BINARY', None, ),  # 5
)
